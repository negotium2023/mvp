    ...
    <div class="content-container">
        <div class="row col-md-12">
            ...
            <div class="container-fluid">
                {{Form::open(['url' => route('areas.store'), 'method' => 'post'])}}
                ...
                <div class="form-group mt-3">
                    ...
                    {{Form::select('region',$regions,old('region'),['class'=>'form-control'. ($errors->has('region') ? ' is-invalid' : ''),'placeholder'=>'Please Select'])}}
