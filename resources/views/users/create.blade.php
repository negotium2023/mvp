        ...
        <div class="row col-md-12 h-100 pr-0">
            ...
            <div class="container-fluid index-container-content">
                <div class="table-responsive h-100">
                    {{Form::open(['url' => route('users.store'), 'method' => 'post','files'=>true,'id'=>'save_user_form'])}}
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{route('avatar',null)}}" id="blackboard-preview-large" class="blackboard-avatar blackboard-avatar-profile"/>
                        <img src="{{route('avatar',null)}}" id="blackboard-preview-small" class="blackboard-avatar blackboard-avatar-navbar-img ml-3"/>
                    </div>
                    @if(auth()->user()->is('manager'))
                    <div class="form-group">
                        {{Form::label('role', 'Role')}}
                        {{Form::select('role[]',$roles,old('role[]'),['class'=>'form-control form-control-sm chosen-select'. ($errors->has('role') ? ' is-invalid' : ''),'multiple'])}}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('division[]',$divisions,old('division[]'),['class'=>'form-control form-control-sm chosen-select'. ($errors->has('division') ? ' is-invalid' : ''),'multiple'])}}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('region[]',$regions,old('region[]'),['class'=>'form-control form-control-sm chosen-select'. ($errors->has('region') ? ' is-invalid' : ''),'multiple'])}}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('area[]',$areas,old('area[]'),['class'=>'form-control form-control-sm chosen-select'. ($errors->has('area') ? ' is-invalid' : ''),'multiple'])}}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('office[]',$offices,old('office[]'),['class'=>'form-control form-control-sm chosen-select'. ($errors->has('office') ? ' is-invalid' : ''),'multiple'])}}
