...
@section('title') Show Custom Report - {{$report_name}}@endsection
@section('header')
        ...
        <form class="mt-3">
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    {{Form::select('user',$assigned_user,old('user'),['class'=>'chosen-select form-control', 'placeholder'=>'User'])}}
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    {{Form::select('trigger',$trigger,old('trigger'),['class'=>'chosen-select form-control form-control-sm', 'placeholder' => 'Trigger Type'])}}
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <a href="{{route('custom_report.show',$report_id)}}" class="btn btn-sm btn-info"><i class="fa fa-eraser"></i> Clear</a>
                    </div>
                </div>
            </div></form>
            <div class="form-row">
