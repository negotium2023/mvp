...
@section('title') Upload Document Template @endsection
    ...
    <div class="content-container page-content">
        <div class="row col-md-12 h-100 pr-0">
            ...
            <div class="container-fluid index-container-content">
                ...
                {{Form::open(['url' => route('templates.store'), 'method' => 'post','files'=>true,'id'=>'save_template_form'])}}

                    <div class="form-group mt-3">
                        {{Form::label('ttype', 'Template Type')}}
                        {{Form::select('ttype',['0'=>'General','1'=>'Report','2'=>'Activity'],old('ttype'),['class'=>'form-control form-control-sm'. ($errors->has('name') ? ' is-invalid' : ''),'id'=>'ttype'])}}
                ...
                <div class="form-group">
                    ...
                    {{Form::select('process',$process,old('process'),['class'=>'form-control form-control-sm'. ($errors->has('process') ? ' is-invalid' : ''),'id'=>'process'])}}
