...
@section('title') Create Office @endsection
        ...
        <div class="row col-md-12 h-100 pr-0">
            ...
            <div class="container-fluid index-container-content">
                <div class="table-responsive h-100">
                    {{Form::open(['url' => route('offices.store'), 'method' => 'post','id'=>'save_office_form'])}}
                    ...
                    <div class="form-group mt-3">
                        ...
                        {{Form::select('area',$areas,old('area'),['class'=>'form-control form-control-sm'. ($errors->has('area') ? ' is-invalid' : ''),'placeholder'=>'Please Select'])}}
