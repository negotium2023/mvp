...
@section('title') Conversion time @endsection
...
@section('content')
    <form class="form-inline mt-3">
        ...
        &nbsp; for &nbsp;
        {{Form::select('type',$types,old('type'),['class'=>'form-control form-control-sm','id'=>'converted_end_date'])}}
        &nbsp; for &nbsp;
...
@section('extra-js')
    <script>
        $("#converted_end_date, #converted_end_date").change(function () {
