...
@section('tab-content')
    <div class="container-fluid">
        {{Form::open(['url' => route('forms.uploadstore',$client->id), 'method' => 'post','files'=>true])}}

        <div class="form-group mt-3">
            {{Form::label('form_type', 'Form Type')}}
            {{Form::select('form_type',["" => "Select","CRF Form"=>"CRF Form","Other" =>"Other"],old('form_type'),['class'=>'form_type form-control form-control-sm'. ($errors->has('form_type') ? ' is-invalid' : '')])}}
        ...
        <div class="form-group mt-3 form-name" style="display:none;">
