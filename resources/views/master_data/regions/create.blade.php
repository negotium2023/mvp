        ...
        <div class="row col-md-12 h-100 pr-0">
            ...
            <div class="container-fluid index-container-content">
                <div class="table-responsive h-100">
                    {{Form::open(['url' => route('regions.store'), 'method' => 'post','id'=>'save_region_form'])}}
                    ...
                    <div class="form-group mt-3">
                        ...
                        {{Form::select('division',$divisions,old('division'),['class'=>'form-control form-control-sm'. ($errors->has('division') ? ' is-invalid' : ''),'placeholder'=>'Please Select'])}}
