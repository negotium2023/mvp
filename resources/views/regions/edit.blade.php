    ...
    <div class="content-container">
        <div class="row col-md-12">
            ...
            <div class="container-fluid">
                {{Form::open(['url' => route('regions.update',$region), 'method' => 'put'])}}
                ...
                <div class="form-group mt-3">
                    ...
                    {{Form::select('division',$divisions,$region->division_id,['class'=>'form-control'. ($errors->has('division') ? ' is-invalid' : ''),'placeholder'=>'Please Select'])}}
