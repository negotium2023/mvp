    ...
    <div class="content-container">
        <div class="row col-md-12">
            ...
            <div class="container-fluid">
                {{Form::open(['url' => route('offices.update',$office), 'method' => 'put'])}}
                ...
                <div class="form-group mt-3">
                    ...
                    {{Form::select('area',$areas,$office->area_id,['class'=>'form-control'. ($errors->has('area') ? ' is-invalid' : ''),'placeholder'=>'Please Select'])}}
