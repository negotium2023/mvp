...
@section('title') Edit <strong>{{$card->card->name}}</strong> Card @endsection
        ...
        <div class="row col-md-12 h-100 pr-0">
            ...
            <div class="container-fluid index-container-content">
                <div class="table-responsive h-100">
                    {{Form::open(['url' => route('card.updatecard',$card), 'method' => 'put','class'=>'mt-3 mb-3 form-inline','id'=>'save_card_section_card'])}}
                    <div class="col-md-12">
                        <div class="form-row w-100">
                            <div class="form-group col-md-12 pt-0 pb-0">
                                {{Form::label('name', 'Name',['style'=>'justify-content:left !important;'])}}
                                <div class="col-md-11">
                                    {{Form::text('name',$card->name,['class'=>'form-control form-control-sm w-100'. ($errors->has('name') ? ' is-invalid' : ''),'placeholder'=>'Name'])}}
                    ...
                    <div class="col-md-12">
                        {{Form::label('fields', 'Fields')}}
                            <blackboard-cards-editor  ref="section_a" :black-inputs="{{$inputs}}" :black-fields="{{$fields}}"></blackboard-cards-editor>
                    </div>
